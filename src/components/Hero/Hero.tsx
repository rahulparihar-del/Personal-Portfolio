...
const Hero: React.FC = () => {
  return (
    <div className="min-h-[90vh] flex items-center bg-gradient-to-br from-white to-white text-white" id="home">
      <div className="container mx-auto px-6 pt-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
